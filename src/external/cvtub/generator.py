...
from .utils import save_nii, slices, project_average  # polnet: relative import (was ``from cvtub.utils ...``)
from .filters import GeneralGaussianBlur3D_periodic, GeneralGaussianBlur3D_notperiodic  # polnet: relative import (was ``from cvtub.filters ...``)
from .filters import my_custom_GradHess  # polnet: relative import (was ``from cvtub.filters ...``)

from .energy import polykap_deg2, ratio_discr  # polnet: relative import (was ``from cvtub.energy ...``)
...
def _generate_shape(v0, params, delta_x, xi, optim_method, optim_props, 
    ...
    if flow_type == 'cons' :
        from .filters import my_custom_Div  # polnet: relative import (was ``from cvtub.filters ...``)
